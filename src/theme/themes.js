...
export const THEME_REGISTRY = Object.freeze({
  light: Object.freeze({
    ...
    '--theme-rule-part-bg': '#f9fafb',
    '--theme-rule-part-text': '#9ca3af',
    '--theme-rule-part-border': 'transparent',
  ...
  dark: Object.freeze({
    ...
    '--theme-rule-part-bg': 'rgba(255, 255, 255, 0.1)',
    '--theme-rule-part-text': 'rgba(255, 255, 255, 0.5)',
    '--theme-rule-part-border': 'transparent',
  ...
  bw: Object.freeze({
    ...
    '--theme-edit-container-bg': 'rgba(0, 0, 0, 0.1)',
    '--theme-rule-part-bg': 'rgba(0, 0, 0, 0.05)',
