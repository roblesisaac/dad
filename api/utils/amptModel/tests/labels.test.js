...
describe('labelsMap', () => {
  ...
  //   expect(async () => await concatLabelMap.createLabelKeys('mustbearray', { name: 'John' }))
  ...
  //   expect(async () => await concatLabelMap.createLabelKeys('keysmustbevalid', { name: 'Johnp' }))
  //   .rejects.toThrowError(errorMessage(`Concat key is missing for 'testName'`));
  // });
  ...
  //   expect(async () => await concatLabelMap.createLabelKeys('catcheserror', { name: 'John' }))
  ...
  //   expect(
  //     async () => await concatLabelMap.createLabelKeys('catcheserror', { name: 'John' })
  //   ).rejects
  ...
  //   const concatLabelMap = LabelsMap(collectionName, labelConstruct);
  //   const createdLabels = await concatLabelMap.createLabelKeys('testcollection', { name: 'John' });
